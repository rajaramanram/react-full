        ...
        <div className='container'>
            ...
            <form className="form-horizontal" onSubmit={handleSubmit}>
                <div>
                    ...
                    <input className="input-md  textinput textInput form-control"  type='text' id='username' value={username} onChange={username_Change}></input></div>
                </div>
                <div>
                    <label className="control-label col-md-4"> FIRST NAME:</label>
                    <div className="control-label col-md-8">
                    <input className="input-md  textinput textInput form-control" type='text' id='firstname' value={firstname} onChange={firstname_Change}></input></div>
                </div>
                <div>
                    <label className="control-label col-md-4">LAST NAME:</label>
                    <div className="control-label col-md-8">
                    <input className="input-md  textinput textInput form-control" type='text' id='lastname' value={lastname} onChange={lastname_Change}></input></div>
                </div>
                
                <div>
                    <label className="control-label col-md-4">EMAIL:</label>
                    <div className="control-label col-md-8">
                    <input className="input-md  textinput textInput form-control" type='email' id='email' value={email} onChange={email_Change}></input></div>
                </div>
                <div>
                    <label className="control-label col-md-4">PASSWORD:</label>
                    <div className="control-label col-md-8">
                    
                    <input className="input-md  textinput textInput form-control" type='password' id='password' value={password} onChange={password_Change}></input></div>
                </div>
                <div>
                    <label className="control-label col-md-4">CONFIRM PASSWORD:</label>
                    <div className="control-label col-md-8">

                    <input className="input-md  textinput textInput form-control" type='password' id='confirmPassword' value={confirmPassword} onChange={confirmpassword_Change}></input></div>
                </div>
                <div>
